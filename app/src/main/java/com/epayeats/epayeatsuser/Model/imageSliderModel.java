package com.epayeats.epayeatsuser.Model;
...
public class imageSliderModel {
    ...
    public imageSliderModel(String id, String imageUrl, String localAdminID, String localAdminName, String lat, String lon, String businessArea, String businessKM) {
        this.id = id;
